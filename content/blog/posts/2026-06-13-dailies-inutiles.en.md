...
title: "Why Daily Standups Are Often Useless"
subtitle: "The daily standup is one of the most universally practiced rituals in development teams. It is also one of the most frequently misused - transformed into a status meeting from which nobody leaves with anything useful."
description: "The Scrum daily standup has a precise goal: synchronize the team and detect blockers. When it becomes an individual activity report, it loses its value and consumes time without producing anything. Here is how to recognize and correct this drift."
