...
excerpt: "Alistair Cockburn a eu une idée simple et puissante : il n'existe pas une seule méthode agile optimale. La bonne méthode dépend de la taille de l'équipe et du risque du projet. Crystal Methods est une famille de méthodes calibrées sur ces deux paramètres."
...
| Critère | Crystal Clear | Scrum | XP |
|---------|---------------|-------|-----|
| Taille équipe | 2-6 | 5-9 | 2-12 |
| Formalisme | Très léger | Modéré | Modéré |
| Pratiques tech | Non prescrites | Non prescrites | Oui (TDD, pair prog) |
| Scalabilité | Famille entière | Scrum of Scrums | Non |
| Localisation | Co-location préférée | Flexible | Co-location préférée |
